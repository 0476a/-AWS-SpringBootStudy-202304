...
INSERT INTO `lecture_mst` VALUES (1,'스프링 부트 - 핵심원리와 활용',99000,1),(2,'스프링 MVC 1편 - 백엔드 웹 개발 핵심 기술',99000,1),(3,'실전! 스프링 부트와 JPA 활용1 - 웹 애플리케이션 개발',88000,1),(4,'스프링 DB 2편 - 데이터 접근 활용 기술',99000,1),(5,'스프링 DB 1편 - 데이터 접근 방식',77000,1),(6,'스프링 핵심원리 - 고급편',121000,1),(7,'토비의 스프링 부트 - 이해와 원리',99000,2),(8,'만들고 비교하며 학습하는 리액트 (React)',55000,3),(9,'[리뉴얼]타입스크립트 올인원 : Part1. 기본문법편',36300,4),(10,'[리뉴얼]React로 NodeBird SNS 만들기',88000,4),(11,'[개정3판] Node.js 교과서 - 기본부터 프로젝트 실습까지',49500,4);
...
INSERT INTO `student_mst` VALUES (1,'김삼겹','2023-04-10'),(2,'박김치','2023-05-10'),(3,'이무쇠','2023-06-10'),(4,'최장기','2023-07-10'),(5,'홍길동','2023-08-10'),(6,'백길동','2023-09-10'),(7,'손두부','2023-10-10'),(8,'이찌개','2023-11-10');
...
INSERT INTO `user_mst` VALUES (1,'abc','$2a$10$LxrktBw8jQbWaC2jlt96qeWuaUdiHTb5wyUfSbU/4LiByaVwPRB9m','김삼겹','abc@gmail.com');
...
-- Dump completed on 2023-04-13 18:48:28
